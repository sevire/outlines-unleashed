...
class document(Root, Structural, Element):
    ...
    def set_name_id_map(self, node, id, msgnode=None, explicit=None):
        ...
        Do not clear the name-to-id map or invalidate the old target if both
        old and new targets are external and refer to identical URIs. The new
        target is invalidated regardless.
