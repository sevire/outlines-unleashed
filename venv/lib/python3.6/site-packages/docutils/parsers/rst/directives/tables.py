...
class CSVTable(Table):
    ...
    def get_csv_data(self):
        """Get CSV data from the directive content, from an external file, or
...
class ListTable(Table):
    ...
    """Implement tables whose data is encoded as a uniform two-level bullet
    list. For further ideas, see
