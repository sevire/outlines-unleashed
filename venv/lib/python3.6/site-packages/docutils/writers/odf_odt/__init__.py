...
class Writer(writers.Writer):
    ...
    def get_stylesheet(self):
        """Get the stylesheet from the visitor. Ask the visitor to setup the
        page.
        """
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def retrieve_styles(self, extension):
        """Retrieve the stylesheet from either a .xml file or from a .odt (zip)
        file. Return the content as a string.
    ...
    def attach_page_style(self, el):
        ...
        Create an automatic-style that refers to the current style of this
        element and that refers to the default page style.
