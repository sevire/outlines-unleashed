...
def _get_wheel_metadata_from_wheel(
    ...
    Fallback for when the build backend does not define the
    'get_wheel_metadata' hook.
...
def build_wheel(wheel_directory, config_settings, metadata_directory=None):
    ...
    If a wheel was already built in the prepare_metadata_for_build_wheel
    fallback, this will copy it rather than rebuilding the wheel.
