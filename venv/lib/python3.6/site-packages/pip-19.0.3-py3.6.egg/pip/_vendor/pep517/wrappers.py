...
class Pep517HookCaller(object):
    ...
    def get_requires_for_build_wheel(self, config_settings=None):
        ...
        This does not include requirements specified in pyproject.toml. It
        returns the result of calling the equivalently named hook in a
        subprocess.
    ...
    def prepare_metadata_for_build_wheel(
        ...
        in a subprocess. If not, the backend will be asked to build a wheel, and
        the dist-info extracted from that.
