...
def getTreeWalker(treeType, implementation=None, **kwargs):
    ...
    Args:
        ...
        kwargs: keyword arguments passed to the etree walker--for other walkers,
            this has no effect
...
def pprint(walker):
    ...
    Takes a TreeWalker instance and pretty prints the output of walking the
    tree.

    Args:
        walker: a TreeWalker instance
    """
    output = []
    indent = 0
