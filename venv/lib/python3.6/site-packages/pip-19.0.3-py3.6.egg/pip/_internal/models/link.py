...
class Link(KeyBasedCompareMixin):
    ...
    def __init__(self, url, comes_from=None, requires_python=None):
        ...
        requires_python:
            String containing the `Requires-Python` metadata field, specified in
            PEP 345. This may be specified by a data-requires-python attribute
            in the HTML link tag, as described in PEP 503.
    ...
    def is_artifact(self):
        ...
        if it points to an "abstract" thing like a path or a VCS location.
        """
