...
class SafeFileCache(FileCache):
    ...
    may not be accessible or writable.
    """
...
def get_file_content(url, comes_from=None, session=None):
    ...
    URL. Returns (location, content). Content is unicode.
...
def unpack_file_url(
    ...
    If download_dir is provided and link points to a file, make a copy of the
    link file inside download_dir.
...
def _copy_dist_from_dir(link_path, location):
    ...
    Invoked when user requests to install a local directory. E.g.:
        ...
        pip install . pip install ~/dev/git-repos/python-prompt-toolkit
...
def unpack_url(
    ...
    Args:
        ...
        only_download:
        session:
        hashes: A Hashes object, one of whose embedded hashes must match, or
            HashMismatch will be raised. If the Hashes is empty, no matches are
...
def _check_download_dir(link, download_dir, hashes):
    ...
    """Check download_dir for previously downloaded file with correct hash If a
    correct file is found return its path else None
