...
def parse_requirements(
    ...
    Args:
        ...
        constraint: If true, parsing a constraint file rather than requirements
            file.
...
def process_line(
    ...
    are from SUPPORTED_OPTIONS_REQ, and they are scoped to the requirement.
    Other options from SUPPORTED_OPTIONS may be present, but are ignored.
...
def expand_env_variables(lines_enum):
    ...
    These points are the result of a discusssion on the `github pull request
    #3514 <https://github.com/pypa/pip/pull/3514>`_ .

    Valid characters in variable names follow the `POSIX standard
    <http://pubs.opengroup.org/onlinepubs/9699919799/>`_ and are limited to
    uppercase letter, digits and the `_` (underscore).
