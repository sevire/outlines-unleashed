...
def make_option_group(group, parser):
    ...
    """Return an OptionGroup object group -- assumed to be dict with 'name' and
    'options' keys parser -- an optparse Parser
...
def check_dist_restriction(options, check_target=False):
    ...
    Args:
        options: The OptionParser options.
        check_target: Whether or not to check if --target is being used.
    """
...
def _merge_hash(option, opt_str, value, parser):
    # type: (Option, str, str, OptionParser) -> None
    """Given a value spelled "algo:digest", append the digest to a list pointed
    to in a dict by the algo name.
