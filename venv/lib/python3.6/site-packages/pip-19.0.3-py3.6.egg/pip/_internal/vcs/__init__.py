...
class VersionControl(object):
    ...
    def _is_local_repository(cls, repo):
        # type: (str) -> bool
        """posix absolute paths start with os.path.sep, win32 ones start with
        drive (like c:\folder)
    ...
    def export(self, location):
        """Export the repository at the url to the destination location i.e.
        only download the files, without vcs informations
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        instead of through the URL. For other subclasses like Git without such
        an option, auth information must stay in the URL.
    ...
    def get_url_rev_and_auth(self, url):
        ...
        """Parse the repository URL to use, and return the URL, revision, and
        auth info to use.
    ...
    def get_url_rev_options(self, url):
        ...
        """Return the URL and RevOptions object to use in obtain() and in some
        cases export(), as a tuple (url, rev_options).
    ...
    def unpack(self, location):
        # type: (str) -> None
        """Clean up current location and download the url repository (and vcs
        infos) into location
    ...
    def get_src_requirement(cls, location, project_name):
        """Return a string representing the requirement needed to redownload the
        files currently present in location, something like:
    ...
    def run_command(
        ...
        # type: (...) -> Optional[Text]
        """Run a VCS subcommand This is simply a wrapper around call_subprocess
        that adds the VCS command name, and checks that the VCS is available
    ...
    def controls_location(cls, location):
        # type: (str) -> bool
        """Check if a location is controlled by the vcs. It is meant to be
        overridden to implement smarter detection mechanisms for specific vcs.
