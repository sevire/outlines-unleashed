...
class TestJsonDescVersionNumber(TestCase):
    def test_json_desc_version_number(self):
        ...
        :return:
        """
        json_descriptor_generic_levels = os.path.join(test_resources_root, "custom_json_test_descriptors_generic_levels.json")
        opml_file_name = os.path.join(test_resources_root, "custom_json_test_descriptors.opml")
        root_node_index = 1
